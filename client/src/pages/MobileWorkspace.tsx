...
export default function MobileWorkspace(){
    ...
    return (
        <div className="d-flex fd-column g-20 auto-scroll w-100" id="workspace">
            <section className="d-flex jc-space-between ai-center">
                <Typography variant="h6">Generate Image</Typography>
                <Button variant="contained" className="main-gradient"
            ...
            <section id="result-image">
                {
                    isLoading ? 
                    <div id="loader">
                        <Skeleton variant="rectangular" style={{width: '100%', height: `${window.innerWidth - 50}px`}} 
                        // animation="wave"
                        />
